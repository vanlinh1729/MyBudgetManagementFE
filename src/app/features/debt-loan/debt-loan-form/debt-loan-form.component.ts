  ...
  template: `
    <div class="flex flex-col h-full bg-white">
      <div class="flex items-center gap-4 px-4 md:px-6 py-4 border-b border-[#e7edf3]">
        ...
        <div>
          <h1 class="text-[#0e141b] text-xl md:text-2xl font-bold">Thêm khoản nợ/cho vay</h1>
          <p class="text-[#4e7397] text-sm">Tạo khoản nợ hoặc cho vay mới</p>
        </div>
      </div>
...
export class DebtLoanFormComponent {} 